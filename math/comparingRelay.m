...
%considering a specific interval in seconds with 5 packages pr. second send rate
%START configure 
interval = 3600;
p_rate = 5/1;
...
num_packages = p_rate * interval;   %all packages in interval
...
%RELAY
t_relay_sys_idle = num_motes_relay*interval - t_send_relay_sys*num_packages*re_relay - t_retrans_relay_sys*num_relay_retrans;
%assert(t_relay_sys_idle>0)
e_relay_sys = t_relay_sys_idle*p_receive_idle + e_send_relay_sys*num_packages*re_relay + e_retrans_relay_sys*num_relay_retrans

%NO RELAY
t_sys_idle = num_motes*interval - t_send_sys*num_packages*re - t_retrans_sys*num_retrans;
%assert(t_sys_idle>0)
e_sys = t_sys_idle*p_receive_idle + e_send_sys*num_packages*re + e_retrans_sys*num_retrans
